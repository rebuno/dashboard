...
export default function PolicyEvalPanel({ p50, p95, p99 }: Props) {
  ...
  return (
    <MetricPanel title="Policy Eval Duration" subtitle="Percentiles (p50 / p95 / p99)" expandedChildren={expandedContent}>
      {content}
    </MetricPanel>
  );
}
